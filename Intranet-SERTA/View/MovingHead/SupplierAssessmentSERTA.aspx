<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/View/Shared/SertaIntra.Master" Culture="auto" CodeBehind="SupplierAssessmentSERTA.aspx.vb" Inherits="IntranetSerta.SupplierAssessmentSERTA" %>

<%@ Import Namespace="Supplier_Indicator" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
            ...
            <div style="border-radius: 20px;">
                <table>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <span class="Label">PPM : Objectif 500PPM</span>
                                <span class="labelInfo">2pts de malus par tranche de 1000PPM</span>
                            </td>
                            <td>
                                <asp:TextBox ID="textBoxIndicePPMvalue" runat="server" AutoPostBack="false" CausesValidation="True" CssClass="NumberBox"></asp:TextBox>
                                <br />
                        ...
                        <tr>
                            <td>
                                <span class="Label">Nombre d&#39;incidents qualité</span>
                                <span class="labelInfo">5 pts de malus par incident</span>
                            </td>
                            <td>
                                <asp:TextBox ID="textBoxSinNBValue" runat="server" CssClass="NumberBox" AutoPostBack="false" CausesValidation="True"></asp:TextBox>
                                <br />
                        ...
                        <tr>
                            <td>
                                <span class="Label">Nombre de retour client</span>
                                <span class="labelInfo">15pts de malus par incident</span>
                            </td>
                            <td>
                                <asp:TextBox ID="textBoxCustomerClaimNBValue" CausesValidation="True" runat="server" CssClass="NumberBox" AutoPostBack="false"></asp:TextBox>
                                <br />
                        ...
                        <tr>
                            <td>
                                <span class="Label">Réactivité et efficacité des plans d'action correctifs et préventif</span>
                            </td>
                            <td></td>
                            <td>
                                <asp:TextBox ID="textBoxActionPlanReactivity" runat="server" CausesValidation="True" CssClass="NumberBox" AutoPostBack="false"></asp:TextBox>/5
                        ...
                        <tr>
                            <td>
                                <span class="Label">Bonus < 500 PPM</span>
                            </td>
                            <td></td>
                            <td>
                                <asp:TextBox ID="textBoxBonusPPM" runat="server" CssClass="NumberBox"  AutoPostBack="false"></asp:TextBox>
                            </td>
                        </tr>
                        <tr>
                            <td><span class="Label">Plan de progrès</span> <asp:CheckBox runat="server" ID="checkBoxImprovement" /> enable</td>
                            <td></td>
                            <td>
                    ...
                    <tfoot>
                        <tr>
                            <td colspan="2">
                                <span class="Label">Total Qualité </span>
                            </td>
                            <td>
            ...
            <table>
                <thead>
                    <tr>
                        <td colspan="3"></td>
                        <td style="width: 10%">Valeur</td>
                        <td colspan="3 " style="width: 20%">Note</td>
                    </tr>
                </thead>
                <tbody>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="textboxLogisticRateValue" runat="server" CssClass="NumberBox" CausesValidation="True" AutoPostBack="false"></asp:TextBox>
                            <br />
                    ...
                    <tr>
                        <td colspan="3">
                            ...
                            <span class="labelInfo">-horizon des commandes ferme<br />
                                -ajustement délais et quantité entre PV et appels de livraison<br />
                                -dépannages
                            </span>
                        </td>
                        <td></td>
                        <td>
                            <asp:TextBox ID="textboxFlexibilityPoint" runat="server" CssClass="NumberBox" CausesValidation="True" AutoPostBack="false"></asp:TextBox>
                            /8
                    ...
                    <tr>
                        <td colspan="5" style="text-align:center;">
                            <asp:Chart ID="ChartHorizonOrder" runat="server" CssClass="graphique" Width="1100px">
                                <Legends>
                                    <asp:Legend Name="legend"></asp:Legend>
                                </Legends>
                                <Titles>
                                    <asp:Title Name="Titre" Text="Horizon de Commande"></asp:Title>
                                </Titles>
                                <Series>
                    ...
                    <tr>
                        <td colspan="3">
                            <span class="Label">Qualité de livraison</span>
                            <span class="labelInfo">2pts si pas d'incident logistique</span>
                        </td>
                        <td class="auto-style1">
                            <asp:TextBox ID="textboxDeliveryQualityValue" CausesValidation="True" runat="server" CssClass="NumberBox" AutoPostBack="false"></asp:TextBox>
                            <br />
                    ...
                    <tr>
                        <td colspan="3">
                            <span class="Label">Plan de progrès</span>
                        </td>
                        <td></td>
                        <td>
                ...
                <tfoot>
                    <tr>
                        <td colspan="4">
                            <span class="Label">Total logistique</span>
                        </td>
                        <td>
            ...
            <table>
                ...
                <tbody>
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxImprovmentPlan" CausesValidation="True" runat="server" CssClass="NumberBox" AutoPostBack="false"></asp:TextBox>
                            /5 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxBusinessRelationship" CausesValidation="True" runat="server" CssClass="NumberBox" AutoPostBack="false"></asp:TextBox>
                            /4
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxFinancialSituation" CausesValidation="True" runat="server" CssClass="NumberBox" AutoPostBack="false"></asp:TextBox>
                            /5 
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxOffersReactivity" CausesValidation="True" runat="server" CssClass="NumberBox" AutoPostBack="false"></asp:TextBox>
                            /2
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxTechnicalAnswerQuality" CausesValidation="True" runat="server" CssClass="NumberBox" AutoPostBack="false"></asp:TextBox>
                            /2
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:TextBox ID="TextBoxIsoCertification" CausesValidation="True" runat="server" CssClass="NumberBox" AutoPostBack="false"></asp:TextBox>
                            /2
    ...
    <div>
        <fieldset>
            <legend>Cotation total</legend>
            <table>
                <tfoot>
                    <tr>
                        <td><span class="Label">Score total</span></td>
                        <td>
            ...
            <fieldset>
                <legend>Tendance :</legend>
                <div>
                    <asp:RadioButtonList ID="RadioButtonListTrend" runat="server" AutoPostBack="false" RepeatDirection="Horizontal">
